...
# ---------------------------------------------------------------------------
# The download-gated entry point refuses rather than fabricate, and the optional-package
# bridge reports its package absent rather than assume it
# ---------------------------------------------------------------------------
...
def test_devinterp_bridge_reports_the_package_absent():
    """The optional LLC bridge detects the missing package rather than assuming it (DESIGN 2.12)."""
