...
def second_epoch_collapse_autopsy(
    ...
    *,
    ...
    produces, and the design forbids inventing it. The real trajectories come from a training run
    this library does not perform; this function is provable now on synthetic trajectories.
    """
